...
export default function LoadingScreen() {
  ...
  useEffect(() => {
    ...
    // Progression fluide : 0 → 100 en ~2s
  ...
  // Périmètre du cercle SVG (r=44, circumference = 2π*44 ≈ 276.46)
  ...
  return (
    <div
      ...
      style={{
        ...
        // Dégradé rouge signature Mokolo
        background: "linear-gradient(145deg, #C0001A 0%, #D72638 40%, #E8445A 70%, #A51C2B 100%)",
    ...
    >
      {/* ─── Lumière ambiante de fond (effet Canva/Photoshop) ─── */}
      <div
        style={{
          position: "absolute",
          top: "-30%",
      ...
      >
        ...
        >
          <div
            style={{
              ...
              lineHeight: 1,
              textShadow: "0 4px 24px rgba(0,0,0,0.25), 0 1px 0 rgba(255,255,255,0.15)",
            }}
          >
            MOKOLO
          </div>
        ...
        >
          ...
          >
            {/* Piste de fond (blanc très transparent) */}
            <circle
              cx="50"
              cy="50"
              r="44"
          ...
          {/* Intérieur rouge vif avec ombre douce */}
          <div
            style={{
              width: "74%",
              height: "74%",
              borderRadius: "50%",
              background: "radial-gradient(circle at 35% 35%, #FF3A52, #C0001A)",
              boxShadow:
